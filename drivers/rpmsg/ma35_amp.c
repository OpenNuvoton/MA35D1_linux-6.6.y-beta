...
static irqreturn_t ma35_rpmsg_ipi_isr(int irq, void *data)
{
	struct ma35_rpmsg_priv *rpmsg_priv;
...
static int ma35_rpmsg_sendto(struct rpmsg_endpoint *ept, void *data, int len, u32 dst)
{
	return ma35_rpmsg_send(ept, data, len);
}

static int ma35_rpmsg_trysendto(struct rpmsg_endpoint *ept, void *data, int len, u32 dst)
{
	return ma35_rpmsg_send(ept, data, len);
}
...
static const struct rpmsg_endpoint_ops ma35_rpmsg_endpoint_ops = {
	...
	.sendto = ma35_rpmsg_sendto,
	.trysendto = ma35_rpmsg_trysendto,
...
static struct ma35_rpmsg_priv *ma35_rpmsg_register(struct device *parent, struct device_node *node)
{
	...
	ret = rpmsg_ctrldev_register_device(&rpdev->rpdev);
	if (ret) {
...
static const struct of_device_id ma35_amp_of_match[] = {
	{ .compatible = "nuvoton,ma35d1-amp" },
	{ .compatible = "nuvoton,ma35d0-amp" },
	{ .compatible = "nuvoton,ma35h0-amp" },
	{}
};
