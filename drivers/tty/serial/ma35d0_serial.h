...
/*
 *
 *  MA35D0 serial driver header file
 *
 *  Copyright (C) 2017 Nuvoton Technology Corp.
 *
 */

#ifndef __MA35D0_SERIAL_H__
#define __MA35D0_SERIAL_H__
...
struct ma35d0_mem_alloc {
	u64		size;
	u64		vir_addr;
	dma_addr_t		phy_addr;
};

struct ma35d0_ip_rx_dma {
