 ...
 */
static int ma35d1_tsen_get_temp(struct thermal_zone_device *th, int *temp)
{
	struct ma35d1_tmperature_sensor *sensor = thermal_zone_device_priv(th);
	int reg;
...
static const struct thermal_zone_device_ops ma35d1_tz_ops = {
