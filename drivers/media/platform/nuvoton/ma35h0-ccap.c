...
/*
 * MA35H0 Camera Capture Interface Controller (CCAP) driver
 *
			 ...
			 struct v4l2_capability *cap)
{
	...
	strscpy(cap->card, "MA35H0 CCAP Interface", sizeof(cap->card));
...
/* ma35h0_ccap display ioctl operations */
...
static struct platform_driver __refdata ma35h0_ccap = {
	.probe = ccap_probe,
	.remove = ccap_remove,
	.driver = {
		   .name = "ma35h0-ccap",
...
module_platform_driver_probe(ma35h0_ccap, ccap_probe);

MODULE_DESCRIPTION("MA35H0 CCAP driver");
MODULE_LICENSE("GPL v2");
MODULE_VERSION("1.0.0");
MODULE_ALIAS("platform:ma35h0-ccap");
