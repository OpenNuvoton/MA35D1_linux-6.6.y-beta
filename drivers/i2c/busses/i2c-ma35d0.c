...
/*
 * linux/drivers/i2c/busses/i2c-ma35d0.c
 *
...
/* ma35d0_i2c_master_complete
 *
 * complete the message and wake up the caller,
 * using the given return code,
 * or zero to mean ok.
 */
static inline void ma35d0_i2c_master_complete(struct ma35d0_i2c *i2c,
											int ret)
{
...
static inline void ma35d0_i2c_disable_irq(struct ma35d0_i2c *i2c)
{
	unsigned long tmp;
...
static inline void ma35d0_i2c_enable_irq(struct ma35d0_i2c *i2c)
{
	unsigned long tmp;
...
/* ma35d0_i2c_message_start
 *
 * put the start of a message onto the bus
 */
static void ma35d0_i2c_message_start(struct ma35d0_i2c *i2c)
{
...
static inline void ma35d0_i2c_stop(struct ma35d0_i2c *i2c, int ret)
{
	unsigned int i = 0;
	...
	ma35d0_i2c_master_complete(i2c, ret);
}
 ...
 */
static inline int is_lastmsg(struct ma35d0_i2c *i2c)
{
 ...
 */
static inline int is_msglast(struct ma35d0_i2c *i2c)
{
 ...
 */
static inline int is_msgend(struct ma35d0_i2c *i2c)
{
	return i2c->msg_ptr >= i2c->msg->len;
}


static void I2C_SlaveTRx(struct ma35d0_i2c *i2c, unsigned long iicstat)
{
	unsigned char byte;
...
static void i2c_ma35d0_irq_master_TRx(struct ma35d0_i2c *i2c,
 ...
 */
static irqreturn_t ma35d0_i2c_irq(int irqno, void *dev_id)
{
	struct ma35d0_i2c *i2c = dev_id;
	...
	if (i2c->slave_mode)
		...
		i2c_ma35d0_irq_master_TRx(i2c, status);
 ...
 */
static int ma35d0_i2c_doxfer(struct ma35d0_i2c *i2c,
 ...
 */
static int ma35d0_i2c_xfer(struct i2c_adapter *adap,
						struct i2c_msg *msgs, int num)
{
	struct ma35d0_i2c *i2c = (struct ma35d0_i2c *)adap->algo_data;
	int retry;
	int ret;

	for (retry = 0; retry < adap->retries; retry++) {

		ret = ma35d0_i2c_doxfer(i2c, msgs, num);
...
static int ma35d0_reg_slave(struct i2c_client *slave)
{
	struct ma35d0_i2c *priv = i2c_get_adapdata(slave->adapter);
...
static int ma35d0_unreg_slave(struct i2c_client *slave)
{
	struct ma35d0_i2c *priv = i2c_get_adapdata(slave->adapter);
...
static u32 ma35d0_i2c_func(struct i2c_adapter *adap)
{
...
static const struct i2c_algorithm ma35d0_i2c_algorithm = {
	.master_xfer        = ma35d0_i2c_xfer,
	.functionality      = ma35d0_i2c_func,
	.reg_slave	= ma35d0_reg_slave,
	.unreg_slave	= ma35d0_unreg_slave,
};
 ...
 */
static int ma35d0_i2c_probe(struct platform_device *pdev)
{
	struct ma35d0_i2c *i2c;
	struct ma35d0_platform_i2c *pdata = NULL;
	struct resource *res;
	struct i2c_adapter *adap;
	int ret, err;
	int busfreq = 0;
	...
	strlcpy(i2c->adap.name, "ma35d0-i2c", sizeof(i2c->adap.name));
	i2c->adap.owner   = THIS_MODULE;
	i2c->adap.algo    = &ma35d0_i2c_algorithm;
	i2c->adap.retries = 2;
	...
	ret = request_irq(i2c->irq, ma35d0_i2c_irq,
	...
	dev_info(&pdev->dev, "%s: ma35d0 I2C adapter\n",
 ...
 */
static int ma35d0_i2c_remove(struct platform_device *pdev)
{
	struct ma35d0_i2c *i2c = platform_get_drvdata(pdev);
...
static int ma35d0_i2c_suspend(struct device *dev)
{
	struct ma35d0_i2c *i2c = dev_get_drvdata(dev);
...
static int ma35d0_i2c_resume(struct device *dev)
{
	struct ma35d0_i2c *i2c = dev_get_drvdata(dev);
...
static const struct dev_pm_ops ma35d0_i2c_pmops = {
	.suspend    = ma35d0_i2c_suspend,
	.resume     = ma35d0_i2c_resume,
};

#define ma35d0_i2c_PMOPS (&ma35d0_i2c_pmops)

static const struct of_device_id ma35d0_i2c_of_match[] = {
	{ .compatible = "nuvoton,ma35d0-i2c" },
	{	},
};
MODULE_DEVICE_TABLE(of, ma35d0_i2c_of_match);

static struct platform_driver ma35d0_i2c_driver = {
	.probe      = ma35d0_i2c_probe,
	.remove     = ma35d0_i2c_remove,
	.driver     = {
		.name   = "ma35d0-i2c",
		.owner  = THIS_MODULE,
		.of_match_table = of_match_ptr(ma35d0_i2c_of_match),
		.pm = ma35d0_i2c_PMOPS,
	},
};
module_platform_driver(ma35d0_i2c_driver);

MODULE_DESCRIPTION("ma35d0 I2C Bus driver");
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:ma35d0-i2c");
