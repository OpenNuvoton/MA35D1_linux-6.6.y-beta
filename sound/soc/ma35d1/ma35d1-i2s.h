...
extern struct ma35d1_i2s_info *ma35d1_i2s_data;

int ma35d1_dma_create(struct ma35d1_i2s_info *ma35d1_audio);
int ma35d1_dma_destroy(struct ma35d1_i2s_info *ma35d1_audio);

#define DRV_NAME "ma35d1-dai"

#endif /*end _MA35D1_I2S_H */
